export const massages = [
  {
    id: 1,
    name: "Massagem Nuru",
    intro: "Experiência sensorial íntima para relaxar corpo e mente",
    description:
  ...
  },
  {
    ...
    intro: "Prática de presença e respiração para ampliar sensação corporal",
    description:
  ...
  },
  {
    ...
    intro: "Encontro guiado para reconectar corpo e mente",
    description:
  ...
  },
  {
    ...
    intro:
      "Sessão interativa de troca de toques, com participação ativa do cliente",
    description:
